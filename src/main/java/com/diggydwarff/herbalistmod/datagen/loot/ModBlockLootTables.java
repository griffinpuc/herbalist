    ...
    protected void generate() {
        ...
        LootItemCondition.Builder enderpearlBuilder = LootItemBlockStatePropertyCondition
                .hasBlockStateProperties(ModBlocks
                        .ENDERPEARL_HAZE_BLAZEBUD_CROP.get())
                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(EnderpearlHazeCropBlock.AGE, 3));

        LootItemCondition.Builder redstoneBuilder = LootItemBlockStatePropertyCondition
                .hasBlockStateProperties(ModBlocks.REDSTONE_KUSH_BLAZEBUD_CROP.get())
                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(RedstoneKushCropBlock.AGE, 3));
        ...
        LootItemCondition.Builder netherwartBuilder = LootItemBlockStatePropertyCondition
                .hasBlockStateProperties(ModBlocks.NETHERWART_KUSH_BLAZEBUD_CROP.get())
                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherwartKushCropBlock.AGE, 3));

        this.add(ModBlocks.ENDERPEARL_HAZE_BLAZEBUD_CROP.get(), createCropDrops(ModBlocks.ENDERPEARL_HAZE_BLAZEBUD_CROP.get(), ModItems.ENDERPEARL_HAZE_BLAZEBUD_STALK.get(),
                ModItems.ENDERPEARL_HAZE_SEEDS.get(), enderpearlBuilder));

        this.add(ModBlocks.REDSTONE_KUSH_BLAZEBUD_CROP.get(), createCropDrops(ModBlocks.REDSTONE_KUSH_BLAZEBUD_CROP.get(), ModItems.REDSTONE_KUSH_BLAZEBUD_STALK.get(),
                ModItems.REDSTONE_KUSH_SEEDS.get(), redstoneBuilder));
        ...
        this.add(ModBlocks.NETHERWART_KUSH_BLAZEBUD_CROP.get(), createCropDrops(ModBlocks.NETHERWART_KUSH_BLAZEBUD_CROP.get(), ModItems.NETHERWART_KUSH_BLAZEBUD_STALK.get(),
                ModItems.NETHERWART_KUSH_SEEDS.get(), netherwartBuilder));

        this.dropSelf(ModBlocks.DREAMCAP_MUSHROOM.get());

        this.dropSelf(ModBlocks.ETHEREAL_FUNGUS.get());
