...
public class AcidEffectRenderer {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        setUniformEveryPass(chain, "WarpStrength", 0.012f * intensity * ampBoost);
        setUniformEveryPass(chain, "WarpScale", 2.2f);
        setUniformEveryPass(chain, "BreathSpeed", 0.6f * ampBoost);

        setUniformEveryPass(chain, "Aberration", 0.0035f * intensity * ampBoost);
        setUniformEveryPass(chain, "AberrationSpeed", 0.9f * ampBoost);

        setUniformEveryPass(chain, "HueSpeed", 0.15f * ampBoost);
        setUniformEveryPass(chain, "SatBoost", 1.25f);
        ...
        setUniformEveryPass(chain, "TrailStrength", 0.88f);
    }
