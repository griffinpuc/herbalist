...
public class BlazebudCigaretteRecipe extends CustomRecipe {

    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public BlazebudCigaretteRecipe(ResourceLocation id, ItemStack output,
    ...
    public boolean matches(CraftingContainer craftingContainer, Level level) {
        ...
        return !blazebudStack.isEmpty() && !paperStack.isEmpty();
    ...
    public ItemStack assemble(CraftingContainer craftingContainer, RegistryAccess pRegistryAccess) {
        ...
        Item newItem = ModItems.BLAZEBUD_CIGARETTE.get();
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.BLAZEBUD_CIGARETTE_RECIPE_SERIALIZER.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<BlazebudCigaretteRecipe> {
        ...
        public BlazebudCigaretteRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BlazebudCigaretteRecipe(id, output, inputs);
        }

        @Override
        public BlazebudCigaretteRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, BlazebudCigaretteRecipe recipe) {
