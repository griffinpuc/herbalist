...
public class BlazebudCigarRecipe extends CustomRecipe {

    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public BlazebudCigarRecipe(ResourceLocation id, ItemStack output,
    ...
    public ItemStack assemble(CraftingContainer craftingContainer, RegistryAccess pRegistryAccess) {
        ...
        Item newItem = ModItems.BLAZEBUD_CIGAR.get();
    ...
    public static class Serializer implements RecipeSerializer<BlazebudCigarRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(HerbalistMod.MODID,"crafting_special_blazebud_cigar");
        ...
        public BlazebudCigarRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BlazebudCigarRecipe(id, output, inputs);
        }
