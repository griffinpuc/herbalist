...
public class BluntRecipe extends CustomRecipe {
    ...
    public BluntRecipe(ResourceLocation id, ItemStack output,
    ...
    public ItemStack assemble(CraftingContainer craftingContainer, RegistryAccess pRegistryAccess) {
        ...
        Item newItem = ModItems.BLUNT.get();
    ...
    public static class Type implements RecipeType<BluntRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "crafting_special_blunt";
    }

    public static class Serializer implements RecipeSerializer<BluntRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(HerbalistMod.MODID,"crafting_special_blunt");

        @Override
        public BluntRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BluntRecipe(id, output, inputs);
        }
