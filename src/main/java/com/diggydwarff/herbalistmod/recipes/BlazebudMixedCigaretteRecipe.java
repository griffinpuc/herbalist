...
public class BlazebudMixedCigaretteRecipe extends CustomRecipe {
    ...
    public BlazebudMixedCigaretteRecipe(ResourceLocation id, ItemStack output,
    ...
    public boolean matches(CraftingContainer craftingContainer, Level level) {
        ...
        ItemStack tobaccoLooseStack = ItemStack.EMPTY;
        ...
        for(int i = 0; i < craftingContainer.getContainerSize(); ++i) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                } else if (itemstack.getItem() instanceof LooseTobaccoItem) {
                    tobaccoLooseStack = itemstack;
        ...
        return !blazebudStack.isEmpty() && !tobaccoLooseStack.isEmpty() && !paperStack.isEmpty();
    ...
    public ItemStack assemble(CraftingContainer craftingContainer, RegistryAccess pRegistryAccess) {
        ...
        Item newItem = ModItems.BLAZEBUD_MIXED_CIGARETTE.get();

        ItemStack returnStack = new ItemStack(newItem, 1);
        CompoundTag compoundtag = new CompoundTag();

        BlazebudItem item = (BlazebudItem)blazebudStack.getItem();
        String displayType = "";
        ...
        compoundtag.putString("tobacco", tobaccoLooseStack.getDisplayName().getString());
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.BLAZEBUD_MIXED_CIGARETTE_RECIPE_SERIALIZER.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<BlazebudMixedCigaretteRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(HerbalistMod.MODID,"crafting_special_blazebud_mixed_cigarette");

        @Override
        public BlazebudMixedCigaretteRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BlazebudMixedCigaretteRecipe(id, output, inputs);
        }

        @Override
        public BlazebudMixedCigaretteRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, BlazebudMixedCigaretteRecipe recipe) {
